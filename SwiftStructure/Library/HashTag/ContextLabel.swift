...
open class ContextLabel: UILabel, NSLayoutManagerDelegate, UIGestureRecognizerDelegate {
    ...
    public var foregroundColor: (LinkResult) -> UIColor = { (linkResult) in
        ...
        case .userHandle:
            return UIColor.red //UIColor(red: 71.0/255.0, green: 90.0/255.0, blue: 109.0/255.0, alpha: 1.0)
        case .hashtag:
            return UIColor(red: 255.0/255.0, green: 28.0/255.0, blue: 190.0/255.0, alpha: 1.0)
        case .url:
            return UIColor.blue //UIColor(red: 45.0/255.0, green: 113.0/255.0, blue: 178.0/255.0, alpha: 1.0)
        case .textLink:
            return UIColor.yellow //IColor(red: 45.0/255.0, green: 113.0/255.0, blue: 178.0/255.0, alpha: 1.0)
        default:
            return .white
        }
    }
...
//    }
    //Modified Types
    public var linkDetectionTypes: [LinkDetectionType] = [.hashtag] {
        didSet {
            setContextLabelDataWithText(nil)
        }
    }
    ...
    // Selected linkResult
    var selectedLinkResult: LinkResult?
